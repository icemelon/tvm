...
@autotvm.register_topi_compute2("bitserial_conv2d_nchw.x86")
...
@autotvm.register_topi_compute2("bitserial_conv2d_nhwc.x86")
...
@autotvm.register_topi_schedule2("bitserial_conv2d_nchw.x86")
def schedule_bitserial_conv2d_nchw(cfg, outs):
    return _schedule_bitserial_conv2d(cfg, outs)

@autotvm.register_topi_schedule2("bitserial_conv2d_nhwc.x86")
