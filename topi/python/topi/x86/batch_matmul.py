...
@autotvm.register_topi_compute2("batch_matmul.x86")
...
@autotvm.register_topi_schedule2("batch_matmul.x86")
...
@autotvm.register_topi_compute2("batch_matmul_cblas.x86")
...
@autotvm.register_topi_schedule2("batch_matmul_cblas.x86")
