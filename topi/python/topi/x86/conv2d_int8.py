...
@autotvm.register_topi_compute2("conv2d_NCHWc_int8.x86")
...
@autotvm.register_topi_schedule2("conv2d_NCHWc_int8.x86")
...
@autotvm.register_topi_schedule2("conv2d_nhwc_pack_int8.x86")
